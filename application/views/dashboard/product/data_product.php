                                ...
                                <tbody>
                                    ...
                                    foreach ($data_product as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center><a target="_blank" href="<?= base_url() ?>assets/home/foto_produk/<?= $row['photo'] ?>"><img src="<?= base_url() ?>assets/home/foto_produk/<?= $row['photo'] ?>" style="height: 50px; width:50px;" alt=""></a></center>
                                            </td>
                                            <td>
                                                <center>
                ...
                <div class="container">
                    <form action="" id="form" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            ...
                            <label class="col-sm-2" for="">Nama Porduk</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" id="description" cols="1" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2" for="">Kapasitas</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Masukkan Kapasitas" id="capacity" name="capacity" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2" for="">Radius</label>
                            <div class="col-sm-10">
